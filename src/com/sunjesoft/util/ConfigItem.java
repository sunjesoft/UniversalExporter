...
public class ConfigItem {
	protected static Logger logger = Logger.getLogger(ConfigItem.class.getName());
  ...
  private String url ; 
	...
	public String toString () { 
	    ...
	    for ( int i = 0; i < this.queryList.size () ; i ++ ) { 
	    	tmp += "[" + i + "] == Query :  " + this.queryList.get(i).query + "\n" ;
	    }
		return tmp;
	...
	public void loadJSONFromFile ( String fileName ) {
		...
		try { 
			...
			//	System.out.println(data.get("OutputFileName"));
	...
	public QueryList getQueryElement ( int idx ) { 
